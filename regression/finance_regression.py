...
# Riaddestra il modello usando i dati di test, che includono l'outlier
...
print("Score sul test set:", reg.score(feature_test, target_test))
print("Score sul training set:", reg.score(feature_train, target_train))
